    ...
    <div className="h-full bg-gray-50 flex flex-col">
      ...
      <div className="flex-1 overflow-y-auto">
        ...
        <div className="bg-white p-6 border-b border-gray-200">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-gray-600">{simulator.user?.email || 'demo@ecomap.cl'}</p>
        ...
        <div className="p-4">
          ...
          <div className="grid grid-cols-2 gap-4 mb-6">
            ...
            >
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <div className="text-sm text-gray-600">Reportes enviados</div>
                </div>
              </div>
            </motion.div>
            ...
            >
              <div className="flex items-center gap-3">
                ...
                <div>
                  <div className="text-2xl font-bold text-gray-900">{userStats.reportsResolved}</div>
            ...
            >
              <div className="flex items-center gap-3">
                ...
                <div>
                  <div className="text-2xl font-bold text-gray-900">{userStats.pointsEarned}</div>
                  <div className="text-sm text-gray-600">Puntos Eco</div>
                </div>
              </div>
            </motion.div>
            ...
            >
              <div className="flex items-center gap-3">
                ...
                <div>
                  <div className="text-2xl font-bold text-gray-900">{userStats.badgesEarned}</div>
          ...
          {/* Badges */}
          <div className="mb-6">
            <h3 className="text-lg font-semibold text-gray-900 mb-4">Mis Logros</h3>
      ...
      <div className="bg-white border-t border-gray-200 px-4 py-2">
        <div className="flex items-center justify-around">
          <button
            onClick={() => simulator.navigateToScreen('dashboard')}
            className="flex flex-col items-center gap-1 p-2 text-gray-600 hover:text-primary transition-colors"
          >
